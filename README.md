...
## complexPlaneAndSinePlot() <a name = "cpsp"></a>

### Description <a name = "cpspde"></a>
...
## goAndSavePlots() <a name = "gsp"></a>

### Description <a name = "gspdes"></a>
...
### Parameters <a name = "gsppar"></a>
* subsections : list[list]
	- The batched sections of the sine wave.
* savePath : str
	- Defines where the files are to be saved.

### Usage <a name = "gspusa"></a>
```
subsections = batcher(sineWave,               
		      subframeLength = 90,     
		      gapToNextFrame = 1)   
